...
var update_quad = func( ) {
    ...
    setprop("/engines/engine[0]/rpm",  getprop("/controls/flight/elevator")*2000.0);
    setprop("/engines/engine[1]/rpm",   getprop("/controls/flight/elevator")*2000.0);
    setprop("/engines/engine[2]/rpm",  getprop("/controls/flight/elevator")*2000.0);
    setprop("/engines/engine[3]/rpm",   getprop("/controls/flight/elevator")*2000.0);
}
