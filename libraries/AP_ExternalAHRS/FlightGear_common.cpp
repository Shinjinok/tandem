 ...
 */
/*
  suppport for FlightGear CX5/GX5-45 serially connected AHRS Systems
 */
...
#if AP_FLIGHTGEAR_ENABLED

#include "FlightGear_common.h"
...
bool AP_FlightGear::handle_byte(const uint8_t b, DescriptorSet& descriptor)
{
...
bool AP_FlightGear::valid_packet(const FlightGear_Packet & packet)
{
...
AP_FlightGear::DescriptorSet AP_FlightGear::handle_packet(const FlightGear_Packet& packet)
{
...
void AP_FlightGear::handle_imu(const FlightGear_Packet& packet)
{
...
void AP_FlightGear::handle_gnss(const FlightGear_Packet &packet)
{
...
void AP_FlightGear::handle_filter(const FlightGear_Packet &packet)
{
...
Vector3f AP_FlightGear::populate_vector3f(const uint8_t *data, uint8_t offset)
{
    return Vector3f {
...
Quaternion AP_FlightGear::populate_quaternion(const uint8_t *data, uint8_t offset)
{
    return Quaternion {
        be32tofloat_ptr(data, offset),
        be32tofloat_ptr(data, offset+4),
